	...
	<div class="tile is-parent">
		<article class="tile is-child notification is-info">
			...
			<div id="report">
				...
				echo"<center>ค่าเฉลี่ย Rate  ต่อปี</center></br>";
				echo "ประจำปี     :" . date('Y') . "</br></br>";
			...
			<center><input type='button' class="button is-success" value='PrintReport' onclick='printDiv("report")'></center>
		</div>

    ...
    <div class="tile is-parent">
        <article class="tile is-child notification is-info">
            ...
            <div id="report">
                ...
                echo" <h3><center>5 อันดับสกุลเงินที่ขายดีที่สุดประจำวัน</center></h3>";
                echo "รายได้ประจำวันที่ :" . date('Y-m-d') . "</br></br>";
                echo "<table class='table'>";
                echo "<tr><th>1</th><td>USD </td>   <td>4545</td>";
                
                echo "<tr><th>2</th><td>GBP</td> <td>3504></td>";
                echo "<tr><th>3</th><td>SEK</td>  <td>2412</td>";
                echo "<tr><th>4</th><td>CAD</td>  <td>1545</td>";

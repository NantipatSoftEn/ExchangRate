    ...
    <div class="tile is-parent">
        <article class="tile is-child notification is-info">
            ...
            <div id="report">
                ...
                echo" <h3><center>5 อันดับสกุลเงินที่ขายดีที่สุดประจำเดือน</center></h3>";
                echo "รายได้ประจำเดือน :" . date('Y-m-d') . "</br></br>";
                echo "<table class='table'>";
                echo "<tr><th>1</th>    <td>USD</td>    <td>7000</td>";
                echo "<tr><th>2</th>    <td>GBP </td>   <td> 5000</td>";
                echo "<tr><th>3</th>    <td>SEK</td>   <td> 3000</td>";
                echo "<tr><th>4</th>    <td>CAD</td>   <td> 2000</td>";
                echo "<tr><th>5</th>    <td>NOK </td>   <td> 1100</td>";
                echo "</table>";
                ?>
